...
package com.kafka.learning.kafka3satfeb2024.service.datagenerator;

import com.fasterxml.jackson.databind.ObjectMapper;

import com.kafka.learning.kafka3satfeb2024.model.DeliveryAddress;
import com.kafka.learning.kafka3satfeb2024.model.LineItem;
...
public class InvoiceGenerator {
    ...
    public PosInvoice getNextInvoice() {
        ...
        for (int i = 0; i < itemCount; i++) {
            productGenerator.getNextProduct();
            totalAmount = totalAmount + productGenerator.getNextProduct().getTotalValue();
            items.add(productGenerator.getNextProduct());
        }
